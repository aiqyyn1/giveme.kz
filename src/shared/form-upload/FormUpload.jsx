...
const FormUpload = memo(
  ({ onClick, text, handleOnSubmit, handleFileChange, handleDataChange, file }) => {
    return (
      <form onSubmit={handleOnSubmit}>
        ...
        {file && (
          <div className="bg-buttonColor w-96 mt-5 h-10 text-center rounded-lg text-white">
            {file}
          </div>
        )}
        <div>
